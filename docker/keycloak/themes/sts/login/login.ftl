...
<!-- template: login.ftl -->
    ...
    <#if section = "header">
        <span class="kc-title">${msg("loginAccountTitle")}</span>
        <span class="kc-subtitle">${msg("loginSubtitle")}</span>
    <#elseif section = "form">
        <div id="kc-form">
          <div id="kc-form-wrapper">
            <#if realm.password>
                <form id="kc-form-login" class="${properties.kcFormClass!} kc-form-animate" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" novalidate="novalidate">
                    <#if !usernameHidden??>
                        <#assign label>
