...
export default function TestEditPage() {
    ...
    const handleNextStep = async (e) => {
        ...
        try {
            ...
            // Update access type
            await assessmentApi.tests.updateAccessType(testId, form.accessType);

            // Load questions for step 2
            try {
                const questionsRes = await assessmentApi.questions.list(testId);
                    ...
                    <form className="test-create__form" onSubmit={handleNextStep}>
                        ...
                        <div className="test-create__actions">
                            <button
                                ...
                                disabled={savingTest || !form.title.trim()}
                            >
                                {savingTest ? 'Сохранение...' : 'Далее'}
                            </button>
                            <button
                                type="button"
