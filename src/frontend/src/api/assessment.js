...
export const assessmentApiDocs = Object.freeze([
    {service: 'assessment', group: 'Tests', method: 'POST', path: '/api/tests', description: 'Создать тест.'},
    {
        ...
        method: 'GET',
        path: '/api/tests/{id}',
        description: 'Получить тест по id.'
    },
    ...
    {service: 'assessment', group: 'Tests', method: 'PUT', path: '/api/tests/{id}', description: 'Обновить тест.'},
    {
        ...
        description: 'Обновить настройки теста.'
    },
    {
        service: 'assessment',
        group: 'Tests',
    ...
    },
    {
        ...
        description: 'Обновить доступность теста.'
    },
    {
        service: 'assessment',
        group: 'Tests',
    ...
    },
    {
        ...
        description: 'Снять тест с публикации.'
    },
    {service: 'assessment', group: 'Tests', method: 'DELETE', path: '/api/tests/{id}', description: 'Удалить тест.'},
    {
        ...
        description: 'Выдать доступ пользователю.'
    },
    {
        service: 'assessment',
        group: 'Tests',
        ...
        description: 'Выдать доступ группе.'
    },
    {
        service: 'assessment',
        group: 'Tests',
    ...
    },
    {
        ...
        description: 'Получить список доступов.'
    },
    {
        service: 'assessment',
        group: 'Tests',
    ...
    },
    {
        ...
        description: 'Создать вопрос в тесте.'
    },
    {
        service: 'assessment',
        group: 'Questions',
    ...
    },
    {
        ...
        method: 'GET',
        path: '/api/tests/{testId}/questions',
        description: 'Получить список вопросов теста.'
    },
    {
        service: 'assessment',
        group: 'Questions',
    ...
    },
    {
        ...
        method: 'GET',
        path: '/api/tests/{testId}/attempts',
        description: 'Получить попытки по тесту.'
    },
    {
        service: 'assessment',
        group: 'Attempts',
        ...
        description: 'Получить результаты теста.'
    },
    {
        service: 'assessment',
        group: 'Attempts',
        ...
        description: 'Получить попытку по id.'
    },
    {
        service: 'assessment',
        group: 'Attempts',
    ...
    },
    {
        ...
        description: 'Получить мои попытки.'
    },
    {
        service: 'assessment',
        group: 'Attempts',
